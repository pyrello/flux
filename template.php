 ...
 */
function flux_preprocess_page(&$variables) {
	$cover_photo_path = theme_get_setting('cover_photo_path');
	if ($cover_photo_path) {
		// @TODO: make the image style configurable
		$variables['cover_photo'] = theme('image_style', array('style_name' => 'large', 'path' => $cover_photo_path));
	}
}
